        ...
        <div class="flex flex-col justify-center">
            ...
            <div class="mt-10 grid max-w-xl grid-cols-3 gap-3">
                <div class="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-tailor-purple/10">
                    <p class="text-2xl font-black text-tailor-purple">100+</p>
                    <p class="mt-1 text-xs font-bold text-slate-500">Penjahit</p>
                </div>
                <div class="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-tailor-purple/10">
                    <p class="text-2xl font-black text-tailor-purple">1K+</p>
                    <p class="mt-1 text-xs font-bold text-slate-500">Pesanan</p>
                </div>
                <div class="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-tailor-purple/10">
                    <p class="text-2xl font-black text-tailor-purple">4.8</p>
        ...
        <div class="lg:pt-6">
            ...
            <div class="mt-4 rounded-3xl bg-white p-5 shadow-sm ring-1 ring-tailor-purple/10">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="font-black text-tailor-deep">4.9/5 Rating</p>
                        <p class="text-xs font-semibold text-slate-500">Dari ulasan pelanggan</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="p-6">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="min-w-0 flex-1">
                                    ...
                                    <p class="mt-2 text-xs font-bold text-tailor-purple">Rating 4.8</p>
                                </div>
                            </div>
