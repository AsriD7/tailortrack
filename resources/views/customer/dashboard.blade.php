    ...
    <div class="space-y-5">
        ...
        <div class="gradient-brand rounded-2xl p-5 text-white shadow-lg shadow-indigo-200 relative overflow-hidden">
            ...
            <a href="{{ route('customer.profile.edit') }}"
               class="relative z-10 mt-4 inline-flex w-full items-center justify-center gap-2 bg-white text-indigo-700 font-bold px-4 py-2.5 rounded-xl text-sm hover:bg-indigo-50 transition-colors">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
